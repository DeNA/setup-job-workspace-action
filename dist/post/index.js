...
async function restoreWorkspace() {
    ...
    await fs__default.promises.unlink(workspacePath);
    info(`unlink ${workspacePath}`);
    // mv ${GITHUB_WORKSPACE}.bak ${GITHUB_WORKSPACE}
    await fs__default.promises.rename(`${workspacePath}.bak`, workspacePath);
    info(`mv ${workspacePath}.bak ${workspacePath}`);
}
